...
import { Container, Div1, Div2, Div3, MobileIcon, NavItem, NavLink, SocialIcons } from './HeaderStyles';
  ...
  <Container scrollNav={scrollNav}>
    <Div1>
      <Link href='/'>
        ...
        <SiNetflix size='3rem' style={{ border: '1px solid white', borderRadius: '50px'}} /><span style={{ fontSize: '2.5rem', fontWeight: '600', paddingLeft: '5px'}}>Nhan</span>
        </a>
      </Link>
    </Div1>
    <Div2>
