    ...
    <Section id="contact" ref={element}>
      ...
      >
        ...
        <LinkList>
          ...
          <LinkColumn>
            ...
            <LinkItem href="mailto:trantrongnhan97@gmail.com">
              trantrongnhan97@gmail.com
            </LinkItem>
          </LinkColumn>
        </LinkList>
      </motion.div>
      ...
      >
        <Slogan>
          ...
          <SloganText>Living, Learning, and Coding.</SloganText>
        </Slogan>
        <SocialIconsContainer>
          <CompanyContainer>
            <Thank>
              Great! You are here.
              <br />
              Thank you for taking time to discover my portfolio.
              <br />
              If you think that I am meet your requirements and suitable for the
              job.
              <br />
